      ...
      <div className="sidebar__dialogues">
        {dialogues.map((dialogue, index) =>
          ...
          <Profile
            ...
            isHover={true}
            message={(
              dialogue.messages[dialogue.messages.length - 1].receiver === dialogue.receiver
                ? `You: ${dialogue.messages[dialogue.messages.length - 1].message}`
                : dialogue.messages[dialogue.messages.length - 1].message
            )}
          />
        )}
      </div>
